        ...
        <div class="main-content-wrap">
            <div class="flex items-center flex-wrap justify-between gap20 mb-27">
                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <div class="text-tiny">New Management Member</div>
                    </li>
                </ul>
            </div>
            <!-- new-Blog -->
            <div class="wg-box">
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.management.store') }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('designation') is-invalid @enderror" type="text" placeholder="Designation"
                            name="designation" tabindex="0" value="{{ old('designation') }}" aria-required="true"
                    ...
                    <fieldset>
                        ...
                        <textarea  class="flex-grow @error('description') is-invalid @enderror" placeholder="Description"
                            name="description" tabindex="0" aria-required="true" value="{{ old('description') }}" required autocomplete="name"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('order') is-invalid @enderror" type="number" placeholder=""
                            name="order"   aria-required="true" value="{{ old('order') }}" required
