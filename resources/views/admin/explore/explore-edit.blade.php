                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="{{ route('admin.blog.list') }}">
                            <div class="text-tiny">Managements</div>
                        </a>
                    </li>
                    <li>
                        <i class="icon-chevron-right"></i>
                    ...
                    <li>
                        <div class="text-tiny">Edit Management Member</div>
                    </li>
                </ul>
            </div>
            <!-- new-Blog -->
            <div class="wg-box">
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.management.update', $management->id) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('name') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('name', $management->name) }}" required autocomplete="name" autofocus>
                        @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('designation') is-invalid @enderror" type="text" placeholder="Designation"
                            name="designation" tabindex="0" value="{{ old('designation', $management->designation) }}" aria-required="true"
                    ...
                    <fieldset>
                        ...
                        <textarea class="flex-grow @error('description') is-invalid @enderror" placeholder="Description"
                            name="description" tabindex="0" aria-required="true" required autocomplete="name" autofocus>{{ old('description', $management->description) }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('order') is-invalid @enderror" type="number" placeholder=""
                            name="order" aria-required="true" value="{{ old('order', $management->order) }}" required
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" @if(!$management->image) style="display:none" @endif>
                                <img src="{{ asset($management->image?->file) }}" class="effect8" alt="">
                            </div>
