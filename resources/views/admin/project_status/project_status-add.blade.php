                ...
                <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                    ...
                    <li>
                        <a href="{{ route('admin.project_status.list') }}">
                            <div class="text-tiny">Project statuses</div>
                        </a>
                    </li>
                    <li>
                        <i class="icon-chevron-right"></i>
                    ...
                    <li>
                        <div class="text-tiny">New project status</div>
                    </li>
                </ul>
            </div>
            <!-- new-Blog -->
            <div class="wg-box">
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.project_status.store') }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('name') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('name') }}" onchange="stringtoSlug(this.value)" required autocomplete="name" autofocus
                            >
                        @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('slug') is-invalid @enderror" type="text" placeholder="Slug"
                            name="slug" tabindex="0" value="{{ old('slug') }}" onchange="stringtoSlug(this.value)" aria-required="true" required
