        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('admin.member.add') }}"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            ...
                                            <form action="{{ route('admin.member.delete', ['id'=>$member->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button href="{{ route('admin.member.delete', ['id'=>$member->id]) }}"  type="submit" data-confirm-delete="true" class="item text-danger border-0 delete">
