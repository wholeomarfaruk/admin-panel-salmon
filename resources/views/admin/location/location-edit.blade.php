...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-location -->
            <div class="wg-box">
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.location.update', $location->id) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('name') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('name', $location->name) }}" onchange="stringtoSlug(this.value)" required autocomplete="name" autofocus>
                        @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('slug') is-invalid @enderror" type="text" placeholder="Slug"
                            name="slug" tabindex="0" value="{{ old('slug',$location->slug) }}"  onchange="stringtoSlug(this.value)" aria-required="true" required
