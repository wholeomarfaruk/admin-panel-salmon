    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                ...
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.project.update', $project->id) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('title') is-invalid @enderror" type="text" placeholder="Title"
                            name="title" tabindex="0" aria-required="true" value="{{ old('title', $project->title) }}" required
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('facing_land') is-invalid @enderror" type="text"
                            placeholder="Facing Land" name="facing_land" tabindex="0" value="{{ old('facing_land', $project->facing_land) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('floor_number') is-invalid @enderror" type="text"
                            placeholder="Floor Number" name="floor_number" tabindex="0" value="{{ old('floor_number', $project->floor_number) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('front_road') is-invalid @enderror" type="text"
                            placeholder="Front Road" name="front_road" tabindex="0" value="{{ old('front_road', $project->front_road) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('square_ft') is-invalid @enderror" type="text"
                            placeholder="Square Feet" name="square_ft" tabindex="0" value="{{ old('sqare_ft', $project->square_ft) }}"
                            aria-required="true" required autocomplete="sqare_ft" autofocus>
                        @error('sqare_ft')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('building_type') is-invalid @enderror" type="text"
                            placeholder="Building Type" name="building_type" tabindex="0" value="{{ old('building_type', $project->building_type) }}"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('bed_bath_balcony_lift') is-invalid @enderror" type="text"
                            ...
                            value="{{ old('bed_bath_balcony_lift', $project->bed_bath_balcony_lift) }}" aria-required="true" required
                    ...
                    <fieldset class="name">
                        ...
                        <textarea id="description" class="flex-grow @error('description') is-invalid @enderror" placeholder="Description"
                            name="description" tabindex="0" aria-required="true" autocomplete="description" autofocus>{{ old('description', $project->description) }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('map_data') is-invalid @enderror" type="text" placeholder="Map Data"
                            name="map_data" tabindex="0" value="{{ old('map_data', $project->map_data) }}" aria-required="true" required
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('project_status') is-invalid @enderror" type="text" placeholder="Project Status"
                            name="project_status" tabindex="0" value="{{ old('project_status', $project->project_status) }}" aria-required="true" required
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item {{ $project?->pdf ? 'd-flex justify-content-center align-items-center' : '' }}" id="imgpreview-pdf" style="{{ $project->pdf ? '' : 'display:none' }}">
                                @php
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item {{ $project->banner ? 'd-flex justify-content-center align-items-center' : '' }}" id="imgpreview-banner" style="{{ $project->banner ? '' : 'display:none' }}">
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item {{ $project->thumbnail ? 'd-flex justify-content-center align-items-center' : '' }}" id="imgpreview-thumbnail" style="{{ $project->thumbnail ? '' : 'display:none' }}">
