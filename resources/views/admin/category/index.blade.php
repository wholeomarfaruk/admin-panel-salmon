                                ...
                                <tr>
                                    ...
                                    <td  >
                                        <div class="flex items-center justify-start flex-wrap gap10">
                                            {{-- <div class="image">
                                                <img src="{{ asset($category->thumbnail) }}" alt="" class="image">
                                            </div> --}}
                                            <div class="name">
                                    ...
                                    <td>
                                        @if ($category->status == \App\Enums\CategoryStatus::ACTIVE->value)
                                        <span class="badge bg-success  rounded-pill">Active</span>
                                        @elseif ($category->status == \App\Enums\CategoryStatus::INACTIVE->value)
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            ...
                                            <form action="{{ route('admin.category.delete', ['id'=>$category->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button href="{{ route('admin.category.delete', ['id'=>$category->id]) }}"  type="submit" data-confirm-delete="true" class="item text-danger border-0 delete">
