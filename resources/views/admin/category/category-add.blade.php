...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-category -->
            <div class="wg-box">
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.category.store') }}"
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select flex-grow">
                            <select class=" @error('status') is-invalid @enderror" name="status" required>
                                ...
                                <option value="1" {{ old('status', 1) == \App\Enums\CategoryStatus::ACTIVE->value ? 'selected' : '' }}>Active</option>
                                <option value="0" {{old('status', '') == \App\Enums\CategoryStatus::INACTIVE->value ? 'selected' : ''}}>Inactive</option>
