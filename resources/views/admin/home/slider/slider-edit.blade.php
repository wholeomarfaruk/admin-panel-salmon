...
@section('content')
    ...
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <!-- new-Blog -->
            <div class="wg-box">
                <form class="form-new-product form-style-1 needs-validation" action="{{ route('admin.home.slider.update', $slider->id) }}"
                    ...
                    <fieldset>
                        ...
                        <div class="upload-image flex-grow">
                            <div class="item" id="imgpreview" @if(!$slider->file) style="display:none" @endif>
                                <img src="{{ asset($slider?->file) }}" class="effect8" alt="">
                            </div>
