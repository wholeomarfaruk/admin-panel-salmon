        ...
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <a class="tf-button style-1 w208" href="{{ route('admin.home.slider.add') }}"><i
                                ...
                                <tr>
                                    ...
                                    <td  class="">
                                        <div class="flex align-items-center justify-start flex-wrap gap10">
                                            <div class="image" >
                                                <img src="{{ asset($slide?->file) }}" alt="" class="image" >
                                            </div>
                                    ...
                                    <td>
                                        <div class="list-icon-function">
                                            <a href="{{ route('admin.home.slider.edit', ['id'=>$slide->id]) }}">
                                                <div class="item edit">
                                                    <i class="icon-edit-3"></i>
                                                </div>
                                            </a>
                                            <form action="{{ route('admin.home.slider.delete', ['id'=>$slide->id]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button href="{{ route('admin.home.slider.delete', ['id'=>$slide->id]) }}"  type="submit" data-confirm-delete="true" class="item text-danger border-0 delete">
